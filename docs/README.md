...
| [design/proposed-hub-features.md](design/proposed-hub-features.md) | Not-yet-built admin hub proposals — the gate/doctor/config write surface (see `../packages/hub/README.md` for what the hub does today) |
