...
(e.g. [`README.zh-CN.md`](../README.zh-CN.md) next to [`../README.md`](../README.md))
and put a one-line language switcher as the first line of both files, e.g.
`English | [简体中文](README.zh-CN.md)` in the English file and
`[English](README.md) | 简体中文` in the translated one. Only `README.md`
